...
import com.crwu.swt.tableviewer.provider.TableBaseContentProvider;
import com.crwu.swt.tableviewer.provider.TableBaseLabelProvider;
import com.crwu.swt.tableviewer.provider.TableBaseTableSorter;
...
public class TableUtil {
	...
	public static void setCommon(final TableViewer tableViewer , Class<?> classObj){
        ...
        List<TableColumnSetting> tableColumnSettingList = TableColumnUtil.getTableColumnSettingList(classObj);
        tableColumnSettingList.forEach(tableColumnSetting -> {
            TableColumn t = new TableColumn(tableViewer.getTable(),SWT.LEFT);
            t.setText(tableColumnSetting.columnText());
            t.setData(tableColumnSetting);
            t.setWidth(tableColumnSetting.width());
...
//		doTable(tableViewer.getTable());
		...
		tableViewer.setLabelProvider(new TableBaseLabelProvider(classObj));
		tableViewer.setContentProvider(new TableBaseContentProvider(classObj));
